...
export default function Google() {
  ...
  useEffect(() => {
    ...
    const recordClick = async () => {
      ...
      if (!token) {
        console.log('No token found, showing page without recording click');
        setLoading(false);
        return;
      }
...
<<<<<<< HEAD
    ...
    // Use navigate instead of window.location to pass state to the Awareness Page
    navigate('/awareness', { 
        state: { 
          platform: 'google',
          message: token 
            ? 'You just fell for a phishing simulation! This was a fake Google login page.'
            : 'You just interacted with a fake Google login page! Note how realistic it looks.'
        }
      });
  };
